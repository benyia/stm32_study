...
void Serial_Init(void)
{
	...
	USART_InitStruture.USART_BaudRate =  115200;//115200波特率
	USART_InitStruture.USART_HardwareFlowControl = USART_HardwareFlowControl_None;//无流控
	...
	USART_InitStruture.USART_WordLength = USART_WordLength_8b;//8位字长
